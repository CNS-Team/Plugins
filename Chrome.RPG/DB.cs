...
namespace Chrome.RPG
{
    public class DB
    {
        ...
        {
            SqlTable table = new SqlTable("Chrome_RPG", new SqlColumn[]
            {
        ...
        public static bool AddCost(string 玩家名, long 点券, bool 是否头顶显示 = false)
        {
            ...
            if (是否头顶显示 && plr.Count != 0 && Chrome.配置.是否头顶显示货币变化)
            {
                ...
                int color = rd.Next(1, 10);
                switch (color)
                {
                    case 1:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.AntiqueWhite, plr[0].TPlayer.position);
                        break;
                    case 2:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Black, plr[0].TPlayer.position);
                        break;
                    case 3:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Red, plr[0].TPlayer.position);
                        break;
                    case 4:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Green, plr[0].TPlayer.position);
                        break;
                    case 5:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Orange, plr[0].TPlayer.position);
                        break;
                    case 6:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Blue, plr[0].TPlayer.position);
                        break;
                    case 7:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Yellow, plr[0].TPlayer.position);
                        break;
                    case 8:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Brown, plr[0].TPlayer.position);
                        break;
                    case 9:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.Purple, plr[0].TPlayer.position);
                        break;
                    default:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币增加时头顶显示, 点券), Color.AliceBlue, plr[0].TPlayer.position);
                        break;
                }
            }
            //Chrome.Status(plr[0]);
        ...
        public static bool DelCost(string 玩家名, long 点券, bool 是否头顶显示 = false)
        {
            ...
            if (是否头顶显示 && plr.Count != 0 && Chrome.配置.是否头顶显示货币变化)
            {
                ...
                {
                    case 1:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.AntiqueWhite, plr[0].TPlayer.position);
                        break;
                    case 2:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Black, plr[0].TPlayer.position);
                        break;
                    case 3:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Red, plr[0].TPlayer.position);
                        break;
                    case 4:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Green, plr[0].TPlayer.position);
                        break;
                    case 5:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Orange, plr[0].TPlayer.position);
                        break;
                    case 6:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Blue, plr[0].TPlayer.position);
                        break;
                    case 7:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Yellow, plr[0].TPlayer.position);
                        break;
                    case 8:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Brown, plr[0].TPlayer.position);
                        break;
                    case 9:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.Purple, plr[0].TPlayer.position);
                        break;
                    default:
                        Utils.SendCombatMsg(String.Format(Chrome.配置.货币减少时头顶显示, 点券), Color.AliceBlue, plr[0].TPlayer.position);
                        break;
                }
            }
            //Chrome.Status(plr[0]);
