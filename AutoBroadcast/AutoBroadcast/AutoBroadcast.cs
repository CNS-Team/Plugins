...
namespace AutoBroadcast
{
	...
	public class AutoBroadcast : TerrariaPlugin
	{
		...
		private static readonly Timer Update = new Timer(1000.0);
		...
		public void OnChat(ServerChatEventArgs args)
		{
			...
			{
				Broadcast[] broadcasts = Config.Broadcasts;
				Broadcast[] array = broadcasts;
				foreach (Broadcast broadcast in array)
				{
					...
					if (array2.Length != 0)
					{
						BroadcastToGroups(array2, messages, colour);
					}
					else
					{
