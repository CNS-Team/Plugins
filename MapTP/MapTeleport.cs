...
public class MapTeleport : TerrariaPlugin
{
	...
	{
		GetDataHandlers.ReadNetModule.Register((EventHandler<GetDataHandlers.ReadNetModuleEventArgs>)teleport, (HandlerPriority)3, false);
	}
	...
	private void teleport(object unused, GetDataHandlers.ReadNetModuleEventArgs args)
	{
		...
		{
			using (BinaryReader binaryReader = new BinaryReader(((GetDataHandledEventArgs)args).Data))
			{
				Vector2 val = Terraria.Utils.ReadVector2(binaryReader);
