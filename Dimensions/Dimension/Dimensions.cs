        ...
        public override void Initialize()
        {
            ...
            while (true)
            {
                ...
                stringBuilder2.AppendLine($"[c/66FF94:当][c/71FF66:前][c/ABFF66:世][c/E4FF66:界]:[c/FFAE66:{Main.worldName}]");
                    stringBuilder2.AppendLine($"[c/FFD766:当][c/FFBE66:前][c/FFA466:世][c/FF8B66:界][c/FF7166:在][c/FF6674:线]: [c/C8FF66:{TShock.Players.ToList().FindAll((TSPlayer pl) => pl?.Active ?? false).Count}]/{TShock.Config.Settings.MaxSlots}");
