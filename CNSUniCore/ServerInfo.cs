...
namespace CNSUniCore
{
    ...
    public class ServerInfo
    {
        ...
        public string GetUrl(bool https = false)
        {
            ...
            {
                var defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(9, 2);
        ...
        {
            var url = this.GetUrl(false) + "/tokentest?token=" + this.Token;
        ...
        {
            var flag = string.IsNullOrEmpty(this.Token);
            if (flag)
            {
                var url = string.Concat(new string[]
                {
        ...
        public JObject AddUser(UserInfo info)
        {
            ...
            if (flag)
            {
                ...
                var defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(81, 9);
                ...
                var url2 = url + defaultInterpolatedStringHandler.ToStringAndClear();
