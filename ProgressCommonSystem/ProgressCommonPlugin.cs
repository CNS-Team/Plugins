...
public class ProgressCommonPlugin : TerrariaPlugin
{
	...
	private void OnNpcSpawn(NpcSpawnEventArgs args)
	{
		...
		{
			EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs = new EventProgressAdvancedEventArgs
			{
		...
		BossProgress bossProgress = type switch
		{
		...
		BossProgress bossProgress2 = bossProgress;
		BossProgress bossProgress3 = bossProgress2;
		BossProgress bossProgress4 = bossProgress3;
		if (!WorldProgress.CurrentWorldProgress.DownedBoss(bossProgress4))
		{
			BossProgressAdvancedEventArgs bossProgressAdvancedEventArgs = new BossProgressAdvancedEventArgs
			{
	...
	private void OnUpdate(EventArgs args)
	{
		...
		{
			EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs2 = new EventProgressAdvancedEventArgs
			{
		...
		{
			EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs3 = new EventProgressAdvancedEventArgs
			{
		...
		{
			EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs4 = new EventProgressAdvancedEventArgs
			{
		...
		case 1:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs7 = new EventProgressAdvancedEventArgs
				{
		...
		case 2:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs8 = new EventProgressAdvancedEventArgs
				{
		...
		case 3:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs10 = new EventProgressAdvancedEventArgs
				{
		...
		case 4:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs9 = new EventProgressAdvancedEventArgs
				{
					EventProgress = EventProgress.PumpkinMoon,
					Handled = false
				};
		...
		case 5:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs6 = new EventProgressAdvancedEventArgs
				{
					EventProgress = EventProgress.FrostMoon,
					Handled = false
				};
		...
		case 6:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs11 = new EventProgressAdvancedEventArgs
				{
					EventProgress = EventProgress.SolarEclipse,
					Handled = false
				};
		...
		case 7:
			...
			{
				EventProgressAdvancedEventArgs eventProgressAdvancedEventArgs5 = new EventProgressAdvancedEventArgs
				{
	...
	protected override void Dispose(bool disposing)
	{
		if (disposing)
		{
			...
			ServerApi.Hooks.GameUpdate.Deregister((TerrariaPlugin)(object)this, (HookHandler<EventArgs>)OnUpdate);
