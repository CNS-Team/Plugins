...
namespace DataSync
{
    ...
    */
        ...
        private static void EnsureTable()
        {
            ...
            var flag = (int) DbExt.GetSqlType(db) != 1;
            ...
            var sqlTableCreator = new SqlTableCreator(db, queryBuilder2);
        ...
        {
            var flag = !GetJb("哥布林一进行") && (args.npc.netID == 26 || args.npc.netID == 27 || args.npc.netID == 28 || args.npc.netID == 29 || args.npc.netID == 111);
            if (flag)
            {
                RJb("哥布林一进行", "true");
                p1();
            ...
            var flag2 = !GetJb("旧日军团一") && (args.npc.netID == 564 || args.npc.netID == 565);
            if (flag2)
            {
                RJb("旧日军团一", "true");
                p1();
            ...
            var flag3 = !GetJb("哥布林二进行") && args.npc.netID == 471;
            if (flag3)
            {
                RJb("哥布林二进行", "true");
                p1(); return;
            }
            var flag4 = !GetJb("海盗进行") && (args.npc.netID == 212 || args.npc.netID == 213 || args.npc.netID == 214 || args.npc.netID == 215 || args.npc.netID == 216 || args.npc.netID == 491);
            if (flag4)
            {
                RJb("海盗进行", "true");
                p1(); return;
            }
            var flag5 = !GetJb("日蚀一进行") && (args.npc.netID == 158 || args.npc.netID == 159 || args.npc.netID == 461);
            if (flag5)
            {
                RJb("日蚀一进行", "true");
                p1(); return;
            }
            var flag6 = !GetJb("旧日军团二") && (args.npc.netID == 576 || args.npc.netID == 577);
            if (flag6)
            {
                RJb("旧日军团二", "true");
                p1();
            ...
            var flag7 = !GetJb("日蚀二进行") && (args.npc.netID == 253 || args.npc.netID == 477);
            if (flag7)
            {
                RJb("日蚀二进行", "true");
                p1();
            ...
            var flag8 = !GetJb("日蚀三进行") && (args.npc.netID == 460 || args.npc.netID == 463 || args.npc.netID == 466 || args.npc.netID == 467 || args.npc.netID == 468);
            if (flag8)
            {
                RJb("日蚀三进行", "true");
                p1();
            ...
            var flag9 = !GetJb("旧日军团三") && args.npc.netID == 551;
            if (flag9)
            {
                RJb("旧日军团三", "true");
                p1();
            ...
            var flag10 = !GetJb("火星进行") && (args.npc.netID == 381 || args.npc.netID == 382 || args.npc.netID == 383 || args.npc.netID == 384 || args.npc.netID == 385 || args.npc.netID == 386 || args.npc.netID == 389 || args.npc.netID == 390 || args.npc.netID == 392);
            if (flag10)
            {
                RJb("火星进行", "true");
                p1();
        ...
        public static Dictionary<string, bool> GetJbs()
        {
            ...
            using (var 表 = TShock.DB.QueryReader("SELECT * FROM synctable;"))
            {
                while (表.Read())
                {
                    var key = 表.Get<string>("key");
                    var value = 表.Get<bool>("value");
                    list.Add(key, value);
                }
                return list;
            }
        ...
        public static void p1()
        {
            ...
            if (!kg) { return; }
            kg = false;
            foreach (var keyValuePair in GetJbs())
            {
